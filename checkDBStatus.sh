...
# Check Databases in the DG configuration that are ROLE=PRIMARY:
...
# Check databases in the DG configuration that are ROLE=STANDBY (they will have been started NOMOUNT):
